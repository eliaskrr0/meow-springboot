package meow.micro.manager.recipe.utils.messages;
...
public class ValidationMessages {
    ...
    public static final String COLUMN_ID_REL_RECIPE_FOOD_SCHEMA = "ID de la relación entre la receta y los aliemntos";
